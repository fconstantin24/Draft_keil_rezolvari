...
// Pin definition
#define LCD16X2_PIN_RS	GPIO_Pin_5
#define LCD16X2_PIN_RW	GPIO_Pin_4
#define LCD16X2_PIN_EN	GPIO_Pin_10
#define LCD16X2_PIN_D4	GPIO_Pin_9		// 4-bit mode LSB
#define LCD16X2_PIN_D5	GPIO_Pin_7
#define LCD16X2_PIN_D6	GPIO_Pin_6
#define LCD16X2_PIN_D7	GPIO_Pin_5		// 4-bit mode MSB
